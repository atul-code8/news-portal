      ...
      <div className="col-span-1 space-y-8 mx-auto">
        ...
        <div>
          ...
          <div className="mt-4 flex space-x-2 text-sm">
            <img
              src="https://nypost.com/wp-content/uploads/sites/2/2024/04/79582612.jpg?quality=75&strip=all&w=1200"
              alt="Nearly 30 aftershocks recorded around NJ quake epicenter since Friday"
              className="w-32"
            />
            <div>
              <p className="font-semibold">
                Nearly 30 aftershocks recorded around NJ quake epicenter since
                Friday
              </p>
              <em>writter</em>
            </div>
